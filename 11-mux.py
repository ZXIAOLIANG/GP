...
terminal_set = ["a0", "a1", "a2", "d0", "d1", "d2", "d3","d4", "d5", "d6", "d7"]
...
def target_function(solution):
    '''
    solution = [a0, a1, a2, d0, d1, d2, d3, d0, d1, d2, d3]
    '''
    a0 = solution[0]
    a1 = solution[1]
    a2 = solution[2]
...
if __name__ == "__main__":
    ...
    final_program = None
    for i in range(pop_size):
        pop_fitness.append(fitness_evaluation(test_set, answer_list, pop[i]))
    # print(pop_fitness)
    ...
    for i in range(max_iteration):
        ...
        for k in range(pop_size):
            fitness = fitness_evaluation(test_set, answer_list, pop[k])
            # print(fitness)
    ...
    plt.title("11mux GP best fitness progress")
